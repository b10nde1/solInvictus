...
3-Return list of error pages + sitemap.xml + html code and Home page url
...
4-Select sitemap mode (Url option is for Error Pages Activation) and an option if you want or not to open result in other tab.(Sol invictus open result in other tab if total of searched Urls if less than 50)
5-Use 'key' to specify what you search in code (e.g:article).
6-Select txt file.
7-For url mode, select the country and environment.
...
4-Return sitemap.xml, html (home page), home page url and error pages.
